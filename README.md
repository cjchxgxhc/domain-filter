...
![Updated](https://img.shields.io/badge/Updated-2026--07--12_16:38:18-brightgreen?style=flat-square)

## 规则列表

- **Ads Hosts** — 主要引用 217heidai/adblockfilters (lite) 项目规则，增添：手机端应用程序广告、子域名（用于hosts格式）；删除：白名单域名。  
  `Hosts · Domain` · [查看详情](data/rules/ads_hosts)
- **Ads** — 主要引用 217heidai/adblockfilters (lite)、lingeringsound/10007、privacy-protection-tools/anti-AD 项目规则，增添：手机端应用程序广告、国外广告（轻量）；删除：白名单域名。  
