...
![Updated](https://img.shields.io/badge/Updated-2026--07--12_16:48:09-brightgreen?style=flat-square)
...
- **Ads** — 主要引用 217heidai/adblockfilters (lite)、lingeringsound/10007、privacy-protection-tools/anti-AD 项目规则，增添：手机端应用程序广告、国外广告（轻量）；删除：白名单域名、proxy_tld（减小大小）。  
