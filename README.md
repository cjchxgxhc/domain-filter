...
![Updated](https://img.shields.io/badge/Updated-2026--08--09_18:02:21-brightgreen?style=flat-square)

## 规则列表

- **Ads** — 喵喵喵。  
  `AdBlock - Clash - Sing-box - QuantumultX - ShadowRocket - Surge - SmartDNS - Wildcard - Hosts` - [查看详情](data/rules/ads)
- **Ads Big** — 扩展列表喵。  
