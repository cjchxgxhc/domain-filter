...
def generate_readme(out_dir: Path, info: Dict, groups_config: Dict) -> None:
    ...
    lines.extend([
        ...
        "## 🛠️ 如何使用",
        "",
        "### AdGuard / AdBlock Plus / Adguard Home",
        "",
        "直接复制上方 `AdBlock` 链接添加到自定义过滤器。",
        "",
        "**示例**:",
        "```",
        "https://raw.githubusercontent.com/cjchxgxhc/domain-filter/refs/heads/main/OUTPUT/ads/adblock.txt",
        "```",
        "",
        "### Clash / Clash Meta",
        "",
        ...
        "  ads:",
        "    type: http",
        "    url: https://raw.githubusercontent.com/cjchxgxhc/domain-filter/refs/heads/main/OUTPUT/ads/clash.yaml",
        "    interval: 86400",
        "    behavior: domain",
        "",
        "rules:",
        ...
        "        "tag": "ads",",
        "        "format": "binary",",
        "        "url": "https://raw.githubusercontent.com/cjchxgxhc/domain-filter/refs/heads/main/OUTPUT/ads/singbox.json",",
